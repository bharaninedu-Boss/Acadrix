...
renderSubjectDetails=async function(container,code){
    ...
    const resources=[['📚','Course Hub',subject.resource,'Open the dedicated subject resource page.'],['🎯','Important Questions',subject.importantQuestions,'Exam-focused questions.'],['📐','Formula Sheet',subject.formulaSheet,'Quick formula revision.'],['✅','Solved Problems',subject.solvedProblems,'Worked numerical problems.'],['🔁','Last-Day Revision',subject.lastDayRevision,'Fast final revision.'],['📄','Question Bank',subject.questionBank,'Practice questions.']];
